...
Solid Edge Storekeeper is a utility for creating and organizing standard parts.  It is free and open source.  To install, either [<ins>**Clone**</ins>](https://github.com/rmcanany/SolidEdgeStorekeeper/) the GitHub repo, or download the latest [<ins>**Release**</ins>](https://github.com/rmcanany/SolidEdgeStorekeeper/).
