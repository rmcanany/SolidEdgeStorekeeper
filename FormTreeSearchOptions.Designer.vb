...
Partial Class FormTreeSearchOptions
    ...
    Private Sub InitializeComponent()
        ...
        TableLayoutPanel1.Controls.Add(ButtonTemplateDirectory, 0, 0)
        TableLayoutPanel1.Controls.Add(LabelTemplateDirectory, 1, 0)
        TableLayoutPanel1.Controls.Add(ButtonMaterialLibrary, 0, 2)
        TableLayoutPanel1.Controls.Add(LabelMaterialLibrary, 1, 2)
        TableLayoutPanel1.Controls.Add(ButtonDataDirectory, 0, 1)
        TableLayoutPanel1.Controls.Add(LabelDataDirectory, 1, 1)
        TableLayoutPanel1.Controls.Add(CheckBoxAlwaysReadExcel, 0, 4)
        ...
        TableLayoutPanel1.Controls.Add(CheckBoxAutoPattern, 0, 5)
        TableLayoutPanel1.Controls.Add(CheckBoxCheckNewVersion, 0, 8)
        ...
        TableLayoutPanel1.Size = New Size(623, 311)
        TableLayoutPanel1.TabIndex = 0
        ' 
        ' ButtonTemplateDirectory
        ' 
        ButtonTemplateDirectory.Anchor = AnchorStyles.Left
        ButtonTemplateDirectory.BackColor = SystemColors.Control
        ButtonTemplateDirectory.Location = New Point(3, 3)
        ...
        LabelTemplateDirectory.Location = New Point(99, 7)
        ...
        ButtonMaterialLibrary.BackColor = SystemColors.Control
        ButtonMaterialLibrary.Location = New Point(3, 63)
        ...
        LabelMaterialLibrary.Location = New Point(99, 67)
        ...
        ' ButtonDataDirectory
        ' 
        ButtonDataDirectory.BackColor = SystemColors.Control
        ...
        LabelDataDirectory.Location = New Point(99, 37)
        ...
        CheckBoxAlwaysReadExcel.Location = New Point(3, 125)
        ...
        TableLayoutPanel2.Location = New Point(99, 268)
        ...
        ButtonOK.Location = New Point(281, 14)
        ...
        ButtonCancel.Location = New Point(362, 14)
        ...
        ButtonHelp.Location = New Point(443, 14)
        ...
        CheckBoxAutoPattern.Location = New Point(3, 155)
        ...
        CheckBoxCheckNewVersion.Location = New Point(3, 243)
